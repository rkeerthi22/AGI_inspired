...
# Re-export the integrity machinery from `orchestrator.integrity` (added 2026-08-26,
# Move 1 of the W9 5-file split, see REFACTOR_PLAN.md). The 13 functions + 2 constants
# listed below used to live in this module; they were removed (Move 1 patches 1-11)
# and now live in `orchestrator/integrity.py`. The shim re-imports them so every
# existing caller (including the 7 test files) keeps working without source-level edits.
