...
safe_release = {
    ...
    "_requirements_lock_state": {"ok": True, "entries": 10,
                                  "missing_hashes": [], "public_only": True},
    "_bootstrap_hash_enforcement_state": {"ok": True, "missing": []},
    "_hermes_runtime_attestation_state": {"ok": True, "version": "0.20.2",
                                           "revision": "a" * 40, "error": None},
    "_egress_boundary_state": {"ok": True, "broker_endpoint": "127.0.0.1:8787",
                                "error": None},
    "_independent_critic_state": {"ok": True, "worker": "ollama/worker",
                                    "critic": "byteplus_coding/critic",
                                    "manager": "ollama/manager", "error": None},
    "_audit_retention_state": {"ok": True, "checkpoints": 2,
                                 "latest": "2026-09-04T00:00:00+00:00",
                                 "fresh": True, "artifact_ok": True, "error": None},
...
for expected in ("estop_engaged", "no_active_write_owners", "release_branch_master",
                 ...
                 "dependency_versions_exactly_pinned",
                 "bootstrap_enforces_dependency_hashes", "hermes_runtime_attested",
                 "worker_egress_boundary_attested",
                 "independent_critic_routing",
                 "off_machine_audit_retention",
                 "ci_supply_chain_pinned",
